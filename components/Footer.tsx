      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <address className="not-italic space-y-3 text-sm text-primary-200">
              ...
              <div className="flex gap-2">
                ...
                <a href="tel:+4917641963598" className="hover:text-white transition-colors">(+49) 176 419 63598</a>
              </div>
              <div className="flex gap-2">
                <svg className="w-4 h-4 mt-0.5 flex-shrink-0 text-primary-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://www.facebook.com/beinmeditech" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Facebook">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385h-3.047v-3.47h3.047v-2.642c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953h-1.514c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385c5.737-.9 10.125-5.864 10.125-11.854z"/></svg>
            </a>
            <a href="https://www.instagram.com/beinmeditech" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Instagram">
